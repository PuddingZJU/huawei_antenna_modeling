/* by Wei Yang */
/* Last Modified: 2006/09/14 01:59:28 . */

#pragma once

#ifndef MOTIONCLIP_H_HEADER_INCLUDED
#define MOTIONCLIP_H_HEADER_INCLUDED
...

{
	...
	protected:
		 ...
		 * @sa CloneAll()
		 */
		void CloneAllRecursively(MotionClip* pmc, 
			MotionJoint* pmj, MotionJoint* pParentJoint);
		 ...
		 * @sa CloneSkeleton()
		 */
		void CloneSkeletonRecursively(MotionClip* pmc, 
			MotionJoint* pmj, MotionJoint* pParentJoint);

		void ClonePartRecursively(MotionClip* pmc, MotionJoint* pmj, 
			MotionJoint* pParentJoint, int start, int end);
	...
	public:
		...
		//2009.11.17 Li Xiang
		MotionClip* ClonePart( int start, int end );
		...
		*/
		...
		//added by Jin Bingwen at 2010/07/26
		/**
		...
		*/
		...
		// 2009.11.22 LX
		void AdjustToGround(double height = 0.0, bool isscale = false);

		void AdjustToFeet(double height = 0.0, bool isscale = false);
...
#endif /* MOTIONCLIP_H_HEADER_INCLUDED*/
