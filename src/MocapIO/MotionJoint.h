/* by Wei Yang */
/* Last Modified: 2007/04/20 16:43:29 . */

#ifndef MOTIONJOINT_H_HEADER_INCLUDED
#define MOTIONJOINT_H_HEADER_INCLUDED
...
//using namespace std;  // DO NOT write this in a header file!
	...
	*/
	...
	public:
		...
		*/
		...
		MotionJoint* ClonePart( int start, int end );
		...
		//2009.10.31 Li Xiang
		void setScale(const Vector3& scl, int frameno);
		...
		*/
		void setEulerAnglesSequence(EulerAnglesSeq seq);

		/**
		* Get the Rotation Sequence in Euler Angles.
		*/
		EulerAnglesSeq getEulerAnglesSequence(void) const;
...
#endif /* MOTIONJOINT_H_HEADER_INCLUDED*/
